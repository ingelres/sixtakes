...
class SixTakes:
    ...
    def __init__(self, nbPlayers):
        ...
        self.hands      = [[] for i in xrange(nbPlayers)]
        self.graveyards = [[] for i in xrange(nbPlayers)]
    ...
    def start(self):
        ...
        self.hands      = [[self.cards[i] for i in xrange(j*self.__CARDS_PER_PLAYER, (j+1)*self.__CARDS_PER_PLAYER)] for j in xrange(self.nbPlayers)]
